...
4. This will deploy `target/spring-jdbc-with-oracle.war` to the running instance of the server.


Access the application 
---------------------
 
The application will be running at the following URL: <http://localhost:8080/spring-jdbc-with-oracle/>.
